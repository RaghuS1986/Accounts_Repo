...
public class RatePerKGEditingSupport extends EditingSupport {
	private TextCellEditor textEditor;

	public RatePerKGEditingSupport(TreeViewer viewer) {
		super(viewer);
	...
	protected Object getValue(Object arg0) {
		String price = null;
		if ((arg0 instanceof ItemBought)) {
			price = ((ItemBought) arg0).getRatePerKg();
		}
		return price;
	}
