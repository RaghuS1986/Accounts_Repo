...
public class UnloadingChargesEditingSupport extends EditingSupport {
	private TextCellEditor textEditor;

	public UnloadingChargesEditingSupport(TreeViewer viewer) {
		super(viewer);
	...
	protected Object getValue(Object arg0) {
		String price = null;
		if ((arg0 instanceof ItemBought)) {
			price = ((ItemBought) arg0).getUnloadingCharges();
		}
		return price;
	}
	...
	protected void setValue(Object arg0, Object arg1) {
		if ((arg0 instanceof ItemBought)) {
			...
			if (parseInt > 0 && !item.getUnloadingCharges().equals(arg1)) {
				item.setUnloadingChargesChanged(true);
			}
			item.setUnloadingCharges(parseInt+"");
		}
